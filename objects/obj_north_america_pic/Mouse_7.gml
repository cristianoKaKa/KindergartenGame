...
if(x>global.box_2_left && x<global.box_2_right && y>global.box_2_top && y<global.box_2_bottom){
	x = _controller.north_america_pos[0];
	y = _controller.north_america_pos[1];
