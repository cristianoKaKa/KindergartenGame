...
if(place_meeting(x,y,obj_worker1)){
	if(_controller.worker_1[2]=="0" || _controller.worker_1[2]=="blue"){
		x = _controller.pants_x_pos[0];
		y = _controller.pants_y_pos[0];
		worker = 1;
		_controller.worker_1[2]="blue";
	}else{
		worker = 0;
		x = origin_x;
		y = origin_y;
	...
	if(_controller.worker_2[2]=="0" || _controller.worker_2[2]=="blue"){
		x = _controller.pants_x_pos[1];
		y = _controller.pants_y_pos[1];
		worker = 2;
		_controller.worker_2[2]="blue";
	}else{
		x = origin_x;
		y = origin_y;
		worker = 0;
	...
	if(_controller.worker_3[2]=="0" || _controller.worker_3[2]=="blue"){
		x = _controller.pants_x_pos[2];
		y = _controller.pants_y_pos[2];
		worker = 3;
		_controller.worker_3[2]="blue";
	}else{
		x = origin_x;
		y = origin_y;
		worker = 0;
