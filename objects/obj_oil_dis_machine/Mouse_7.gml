...
if(x>global.box_1_left && x<global.box_1_right && y>global.box_1_top && y<global.box_1_bottom){
	x = _controller.machine_pos[0][0];
	y = _controller.machine_pos[0][1];
